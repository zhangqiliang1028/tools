...
int main()
{
        ...
        std::ifstream preifs,ifs1,ifs2,ifs3,ifs4,ifs5,ifs6,ifs7,ifs8;
        ...
        inputsStr="";
        ifs5.open("bottleTool5.txt");
        while(getline(ifs5,onelineStr))
        {
            inputsStr+=onelineStr;
        }
        reader.parse(inputsStr, json);
        ...
        inputsStr="";
        ifs6.open("bottleTool6.txt");
        while(getline(ifs6,onelineStr))
        {
            inputsStr+=onelineStr;
        }
        reader.parse(inputsStr, json);
	...
	inputsStr="";
        ifs7.open("bottleTool7.txt");
        while(getline(ifs7,onelineStr))
        {
            inputsStr+=onelineStr;
        }
        reader.parse(inputsStr, json);
	...
	inputsStr="";
        ifs8.open("bottleTool8.txt");
        while(getline(ifs8,onelineStr))
        {
            inputsStr+=onelineStr;
        }
        reader.parse(inputsStr, json);
                ...
                {   
                    for(int j = 0;j < nums.size(); j++)
                    {
                       ...
                       {   
                           ...
                           if(nums[j]==toolsID[k])
                           {
                              relyOnResults.push_back(toolsResults[k]);                                    //2.toolsResults[k]？
                              break;
                           }  
                       } 
